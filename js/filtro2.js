$(function () {
    ...
    let trabajo = $('#trabajo').offset().top,
        ...
        inicio_sesion = $('#Promocion').offset().top,
    ...
    $('#enlace-Promocion').on('click', function(e){
        e.preventDefault();
        $('html, body').animate({
