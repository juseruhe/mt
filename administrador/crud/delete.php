...
<div class="wrapper">
 ...
 <!-- /.navbar -->
  ...
  <div class="row">
           ...
           $td = $array["ID_Tipo_Documento"];
          

           $consulta2 = "DELETE from usuario where ID_Tipo_Documento = '$td' and  ID_Usuario = '$id' ";

           $query2 = mysqli_query($conectar,$consulta2);
            ...
            ?>
              ...
              <p> Eliminado Datos del Usuario </P>
